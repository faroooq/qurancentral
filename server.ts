...
// const { AppServerModuleNgFactory, LAZY_MODULE_MAP } = require(`./dist/main.${hash}`);
...
// ISSUE : ReferenceError: document is not defined ~Angular Universal - Issue fix with below code
const domino = require("domino");
const fs = require("fs");
const path = require("path");
const templateA = fs.readFileSync(path.join("dist/browser", "index.html"))
  .toString();
...
// remove or comment out these lines in case of prod deployment
// Start up the Node server
// app.listen(PORT, () => {
